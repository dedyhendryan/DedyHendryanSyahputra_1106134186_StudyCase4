package com.tel.dedyhendryan.dedyhendryansyahputra_1106134186_studycase4;
...
public class ListNama extends AppCompatActivity {
    ...
    private String[] mahasiswaArray = {
            "Capt.Vincent Raditya", "Capt.Julian Nur", "Capt.Edward F Limbong", "Capt.Rizka Leihitu", "Capt. Giovanny Mauro",
            "FO Adityarman", "FO Sendyid", "FO Christoperito", "FO Gilang Wardhana", "FO Jason", "FO Rachman", "FO Muhalutfi", "FO Patricia Yora", "FO Sari Ardisa"};
